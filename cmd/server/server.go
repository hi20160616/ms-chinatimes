...
import (
	...
	"github.com/hi20160616/ms-chinatimes/internal/job"
	"github.com/hi20160616/ms-chinatimes/internal/server"
...
func main() {
	...
	g.Go(func() error {
		log.Printf("[%s] MS start at: %s",
			...
			configs.Data.MS["chinatimes"].Addr)
	...
	// Job
	g.Go(func() error {
		log.Printf("[%s] Job is working", configs.Data.MS["chinatimes"].Title)
